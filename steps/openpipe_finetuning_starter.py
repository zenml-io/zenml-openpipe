    ...
    log_metadata(
        metadata={
            "fine_tuning_config": {
                ...
                "wait_timeout_minutes": timeout_minutes
    ...
    try:
        ...
        if existing_model:
            if force_overwrite:
                ...
                log_metadata(metadata={"model_action": "deleted_existing"})
            elif auto_rename:
        ...
        if not (hasattr(e, "status_code") and e.status_code == 404):
            ...
            log_metadata(metadata={"model_check_error": str(e)})
        ...
        if wait_for_completion:
            ...
            while time.time() - start_time < timeout_seconds:
                try:
                    ...
                    log_metadata(metadata={"polling_error": str(e)})
            ...
            if result["status"] == "ready":
                ...
                log_metadata(metadata={"final_status": "success"})
                ...
                log_metadata(
                    metadata={
                        "timeout": {"status": "timed_out", "minutes": timeout_minutes}
                    }
                )
