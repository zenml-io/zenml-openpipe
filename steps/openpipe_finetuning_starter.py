...
def openpipe_finetuning_starter(
    ...
    training_config = {
        ...
        "hyperparameters": {
            "is_sft_enabled": enable_sft,
            "batch_size": batch_size,
            "learning_rate_multiplier": learning_rate_multiplier,
            "num_epochs": num_epochs,
            "is_preference_tuning_enabled": enable_preference_tuning
        }
    }
    
    # Add preference tuning specific parameters if enabled
    if enable_preference_tuning:
        training_config["hyperparameters"].update({
            "preference_tuning_variant": "DPO",
            "preference_tuning_learning_rate_multiplier": learning_rate_multiplier,
            "preference_tuning_num_epochs": num_epochs
        })
